  ...
  try {
    ...
    const flyerData = {
      listing: {
        ...
        floorAreaM2: listing.floorAreaM2 ?? undefined,
        landAreaM2: listing.landAreaM2 ?? undefined,
        cv: listing.cv ?? undefined,
        rv: listing.rv ?? undefined,
        featuresJson: Array.isArray(listing.featuresJson) ? listing.featuresJson as string[] : undefined,
      },
